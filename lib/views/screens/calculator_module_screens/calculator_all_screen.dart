...
class CalculatorAllScreen extends StatefulWidget {
  const CalculatorAllScreen({super.key});

  @override
  State<CalculatorAllScreen> createState() => _CalculatorAllScreenState();
}

class _CalculatorAllScreenState extends State<CalculatorAllScreen> {
  @override
