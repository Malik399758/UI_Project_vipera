...
class PowCoinsScreen extends StatefulWidget {
  const PowCoinsScreen({super.key});

  @override
  State<PowCoinsScreen> createState() => _PowCoinsScreenState();
}

class _PowCoinsScreenState extends State<PowCoinsScreen> {
  @override
